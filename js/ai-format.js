...
6. 仅输出最终 Markdown，不要额外解释。`,
    ...
    async formatCurrentNote() {
        ...
        try {
            ...
            if (btn) {
                btn.disabled = false;
                btn.innerHTML = `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7h16M4 12h16M4 17h10"></path></svg> `;
            }
        }
    },
